...
% Fonts (using fontspec for XeTeX with OpenType files from TeX Live)
...
% Better line breaking and typography
...
\subsubsection*{Papers\footnote{\textasteriskcentered~equal contribution}}
\begin{enumerate}[label={[\arabic*]}]
    \item Ido Maor, Ilana Ascher, Yuan Zhao, Yuji Takahashi, Evan Hart, Francisco Pereira, Geoffrey Schoenbaum. 
          \textit{Persistent representation of a prior schema in the orbitofrontal cortex facilitates learning of a conflicting schema.}
          Nature Communications (in press), 2025.
    \item Rajtarun Madangopal, Yuan Zhao, \ldots. 
